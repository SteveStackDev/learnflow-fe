        ...
        <div className={styles["contest-stats__list"]}>
          {stats.map((obj, index) => (
            <div
              ...
              className={`${styles["contest-stats__card"]} reveal-card`}
            >
              <div
              ...
              <div className={styles["contest-stats__info"]}>
                <span className={styles["contest-stats__label"]}>{obj.title}</span>
                <span className={styles["contest-stats__value"]}>
                  <AnimatedCounter
                    value={obj.title === "Tổng Contest" ? totalContests : obj.value}
                  />
                </span>
              </div>
            </div>
