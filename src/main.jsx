...
const AILearningAlgorithm = lazy(() => import("~/pages/AILearningAlgorithm/AILearningAlgorithm"));
const AILearningSubmissions = lazy(
  () => import("~/pages/AILearningSubmissions/AILearningSubmissions"),
);
const AILearningAnalysis = lazy(() => import("~/pages/AILearningAnalysis/AILearningAnalysis"));
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                <Route element={<MainLayout />}>
                  ...
                  <Route
                    path="/ai-learning/algorithm/:algorithmSlug"
                    element={<AILearningAlgorithm />}
                  />
                  <Route
                    path="/ai-learning/problem/:problemId"
                    element={<AILearningSubmissions />}
                  />
                  <Route
                    path="/ai-learning/submission/:submissionId"
                    element={<AILearningAnalysis />}
                  />
